const { ReplyCommentsController } = require('..');
...
describe('ReplyComments service tests', function () {
  ...
  it('should create reply comment', async () => {
    const response = await replyCommentsController.createReplyComment(
      requestStub,
      responseStub
    );
  ...
  it('should update reply comment', async () => {
    const response = await replyCommentsController.updateReplyComment(
      requestStub,
      responseStub
    );
  ...
  it('should return all reply comments', async () => {
    const response = await replyCommentsController.getReplyComments(
      requestStub,
      responseStub
    );
  ...
  it('should delete reply comment', async () => {
    const response = await replyCommentsController.deleteReplyComment(
      requestStub,
      responseStub
    );
